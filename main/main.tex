...
\end{equation}
where the last $p_2-p_1$ parameters $\theta_{0,{p_1+1}},\cdots,\theta_{0,{p_2}}$ are fixed. We want to test the hypothesis
\begin{equation}
...
The condition~\ref{Assump21} prevents the bad behavior weight function's tail. The condition~\ref{Assump22} is satisfied in most usual case. 
