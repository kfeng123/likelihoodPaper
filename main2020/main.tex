...
However, to the best of our knowledge, the idea has not been systematically studied for general models.
...
In this work, in order to use the Bayes factor to construct frequentist tests, we gives a thorough study of the asymptotic distribution of the Bayes factor and its variants for general models.
