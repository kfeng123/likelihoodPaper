...
\begin{align*}
    ...
    \begin{pmatrix}
        ...
        (1-\omega) p_1^{k-1} + \omega p_2^{k-1} - p_0^{k-1} \\
        \vdots
        \\
    ...
    ,
\end{align*}
and $\BA$ is a $(k+1) \times k$ lower triangular matrix and $(\BA)_{i,j} = (-1)^{i-j} {i-1 \choose j-1}$ for $1\leq j \leq i \leq k $ or $ 1 \leq j< i = k + 1$.
