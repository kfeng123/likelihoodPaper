...
\begin{lemma}
    ...
    Suppose $\{Z_n\}$ is a sequence of $p$-dimensional random variables and $Z_n \rightsquigarrow \mathcal N (\eta, \BI_p)$, and $\{\BP_n\}$ is a sequence of non-random projection matrix with rank $1\leq k \leq p$.
    Suppose $\eta^\myT \BP_n \eta \to \gamma$.
    \begin{align*}
